...
from Encode import GNN_2dEnc, GNN_3dEnc

class Canonical3D(nn.Module):
    """
    ...
    def __init__(self, num_layers, emb_dim, drop_ratio = 0.5, JK = "last", residual = False, gnn_type = 'gin',
        ...
        super(Canonical3D, self).__init__()
        ...
        self.gnn_2d_enc = GNN_2dEnc(self.num_layers, self.emb_dim, self.drop_ratio, self.JK, 
                                    self.residual, self.gnn_type, self.virtual) # size : [N * emb_dim]
        self.gnn_3d_enc = GNN_3dEnc(self.num_layers, self.emb_dim, self.drop_ratio, self.JK, 
